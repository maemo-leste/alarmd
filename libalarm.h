 ...
 *
 * Alarm daemon and libalarm are:<br>
...
// QUARANTINE   /** If the system time is moved forwards, the alarm should be
// QUARANTINE    *  rescheduled.
// QUARANTINE    **/
// QUARANTINE   ALARM_EVENT_FORW_RESCHEDULE  = 1 <<  8,
